    ...
    [
        ...
        html.Div([
            html.Div([
                ...
                dcc.Dropdown(id='dropdown_best_seller_shades_by_countries',
                             options=[{
                                 'label': country,
                                 'value': country
            ...
            html.Div([
                ...
                dcc.RadioItems(id='radio_button_best_selling_brand_by_country',
                               options=[{
                                   'label': country,
                                   'value': country
                               } for country in unique_countries],
        ...
        html.Div([
            ...
            html.Div([
                html.H6("Saturation"),
                dcc.Slider(id='slider_saturation',
                           min=0,
                           max=1,
                           step=0.1,
                           value=0.5,
            ...
            html.Div([
                ...
                dcc.Slider(id='slider_value_brightness',
                           min=0,
                           max=1,
                           step=0.1,
                           value=0.5,
                 ...
                 className="row"),
        # row 6: 1 sub title
        html.Div(children='Most Matching Results:',
